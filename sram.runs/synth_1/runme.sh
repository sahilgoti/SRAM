...
HD_PWD='D:/exchange/MeitY/SRAM/sram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_16x4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_16x4.tcl
