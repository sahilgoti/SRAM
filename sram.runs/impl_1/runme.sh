...
HD_PWD='D:/exchange/MeitY/SRAM/sram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_16x4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sram_16x4.tcl -notrace
