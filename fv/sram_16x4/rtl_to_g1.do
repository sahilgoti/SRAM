set log file fv/sram_16x4/rtl_to_g1.log -replace
...
vpx read guide file fv/sram_16x4/rtl_to_g1.ovf
...
read library -statetable -liberty -both  \
	/home/buet/digital/180nm/dig/lib/slow.lib

add search path -design .
read design  -verilog2k -define SYNTHESIS  -golden -lastmod -noelab \
	sram_16x4.v

elaborate design -golden -root sram_16x4 -rootonly \

read design -verilog -revised -lastmod -noelab \
	-unzip fv/sram_16x4/g1.v.gz

elaborate design -revised -root sram_16x4
